...
public class Infinity
{
    ...
    {
    	/*
    	 * Goes through each registered item and block that has been registered and adds them to UNAVAILABLE.
    	 * This gives the player access to item that are not unavailable such as barriers and command blocks,
    	 * and potentially items that are added by other mods too.
    	 * 
