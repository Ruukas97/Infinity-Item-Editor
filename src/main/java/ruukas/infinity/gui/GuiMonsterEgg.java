...
public class GuiMonsterEgg extends GuiScreen {
	...
	public void initGui() {
		...
		mobSpecificButton = new GuiInfinityButton(105, this.width / 2 - 75, 140, 150, 20,
				I18n.format("gui.spawnegg.mobspecific", getEntityName()));
		this.buttonList.add(mobSpecificButton);

		animalSpecificButton = new GuiInfinityButton(106, this.width / 2 - 75, 140, 150, 20,
				I18n.format("gui.spawnegg.animalspecific", getEntityName()));
		...
		this.buttonList
				.add(new GuiInfinityButton(203, this.width / 2 - 30, this.height - 45, 60, 20, I18n.format("gui.reset")));
	...
	public String getEntityName() {
		if (stack.getItem() == Items.SPAWN_EGG) {
			return I18n.format(
					"entity." + EntityList.getTranslationName(ItemMonsterPlacer.getNamedIdFrom(stack)) + ".name");
		}
		return "Empty";
	}
