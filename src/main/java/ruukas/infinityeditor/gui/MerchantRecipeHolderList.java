...
public class MerchantRecipeHolderList extends ArrayList<MerchantRecipeHolder>
{
    ...
    public MerchantRecipeHolderList(NBTTagCompound compound) {
    ...
    public void readRecipiesFromTags( NBTTagCompound compound )
    {
        ...
        for ( int i = 0 ; i < nbttaglist.tagCount() ; ++i )
        {
            ...
            this.add( new MerchantRecipeHolder( new MerchantRecipe( nbttagcompound ) ) );
        }
    }
    ...
    public static MerchantRecipeHolderList readFromBuf( PacketBuffer buffer ) throws IOException
    {
        MerchantRecipeHolderList merchantrecipelist = new MerchantRecipeHolderList();
        ...
        for ( int j = 0 ; j < i ; ++j )
        {
            ...
            merchantrecipelist.add( new MerchantRecipeHolder( merchantrecipe ) );
        }
